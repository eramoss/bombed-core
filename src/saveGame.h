...
void save_positions(Player& player, EnemyMirror& enemyM, EnemyRandom& enemyR,  Timer timer) {
...
void load_positions(Player& player, EnemyMirror& enemyM, EnemyRandom& enemyR, Bomb& bomb, double& timer) {
